...
RDBMS is the most widely used DBMS. Data is stored in tabular format. SQL is the language we use to access and manipulate the data stored in databases.

1. Why do tables need a `primary key`?

They uniquely identify each record in the table.
...
We need to have a third table that holds foreign keys which reference the primary keys on the related tables.
